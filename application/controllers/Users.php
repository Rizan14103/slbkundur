...
class Users extends CI_Controller {
	...
	public function inventaris ($aksi='', $id='')
	{
	$ceks = $this->session->userdata('surat_menyurat@Proyek-2017');
		if(!isset($ceks)) {
			redirect('web/login');
			...
			$data['level_users']  = $this->Mcrud->get_level_users();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Pengguna | WARIS";
				}elseif ($aksi == 'd') {
					$p = "pengguna_detail";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Detail Pengguna | WARIS";
				}elseif ($aksi == 'e') {
					$p = "pengguna_edit";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Edit Pengguna | WARIS";
				}elseif ($aksi == 'h') {

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Hapus Pengguna | WARIS";
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get("tbl_bagian");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Bagian | WARIS";
				}elseif ($aksi == 'e') {
					$p = "bagian_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Bagian | WARIS";
					...
					$data['query'] = $this->db->get_where("tbl_bagian", array('id_bagian' => "$id"))->row();
					$data['judul_web'] 	  = "Hapus Bagian | WARIS";
    ...
    public function barang($aksi='', $id=''){
        redirect('404_content');
        $ceks    = $this->session->userdata('surat_menyurat@Proyek-2017');
        $id_user = $this->session->userdata('id_user@Proyek-2017');
        if(!isset($ceks)){
            ...
            $data['user']             = $this->Mcrud->get_users_by_un($ceks);
            $this->db->where('tbl_inventaris', "id_user");
		...
		if(!isset($ceks)) {
			...
			$data['ns'] 		  = $this->db->get("tbl_ns");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Nomor Surat |WARIS";
				}elseif ($aksi == 'e') {
					$p = "ns_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Nomor Surat | WARIS";
					...
					$data['query'] = $this->db->get_where("tbl_ns", array('id_ns' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Nomor Surat | WARIS";
					...
					$data['judul_web'] 	  = "Nomor surat | WARIS";
				}
		...
		if(!isset($ceks)) {
			...
			$data['sm'] 		  = $this->db->get("tbl_sm");
				...
				if ($aksi == 't') {
					...
					$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
					$data['judul_web'] 	  = "Edit Surat Masuk | WARIS";
					...
					$data['judul_web'] 	  = "Hapus Surat Masuk | WARIS";
					...
					$data['judul_web'] 	  = "Surat Masuk | WARIS";
				}
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get_where("tbl_bagian","id_user='$id_user'")->result();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Surat Keluar | WARIS";
					...
					$data['judul_web'] 	  = "Detail Surat Keluar | WARIS";
					...
					$data['judul_web'] 	  = "Edit Surat Keluar | WARIS";
					...
					$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Surat Keluar | WARIS";
					...
					$data['judul_web'] 	  = "Surat Keluar | WARIS";
				}
		...
		if(!isset($ceks)) {
			...
			$data['memo'] 		  = $this->db->get("tbl_memo");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Memo | WARIS";
				}elseif ($aksi == 'e') {
					$p = "memo_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Memo | WARIS";
					...
					$data['query'] = $this->db->get_where("tbl_memo", array('id_memo' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Memo | WARIS";
	...
	public function lap_sk()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Keluar | WARIS";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Keluar | WARIS";
								$this->load->view('users/header', $data);
	...
	public function lap_sm()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Masuk | WARIS";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Masuk | WARIS";
								$this->load->view('users/header', $data);
	...
	public function karyawan ($aksi='', $id='')
	{
	$ceks = $this->session->userdata('surat_menyurat@Proyek-2017');
		if(!isset($ceks)) {
			redirect('web/login');
		}else{
			$data['user']  			  = $this->Mcrud->get_karyawan_by_un($ceks);
			...
			$this->db->order_by('id_user', 'DESC');
			$data['level_karyawan']  = $this->Mcrud->get_level_karyawan();
				...
				if ($aksi == 't') {
					...
					$data['query'] = $this->db->get_where("tbl_karyawan", "id_userKR = '$id'")->row();
					$data['judul_web'] 	  = "Detail Pengguna | WARIS";
				}elseif ($aksi == 'e') {
					$p = "penggunaKR_edit";
					...
					if ($ceks == $data['query']->username) {
						...
						$this->Mcrud->delete_karyawan_by_id($id);
						$this->session->set_flashdata('msg',
							'
							<div class="alert alert-success alert-dismissible" role="alert">
								 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
					...
					if (isset($_POST['btnsimpan'])) {
						...
						$password	 		  = htmlentities(strip_tags($this->input->post('password')));
						$password2	 		= htmlentities(strip_tags($this->input->post('password2')));
						$NIK					= htmlentities(strip_tags($this->input->post('NIK')));
						$level	 				= htmlentities(strip_tags($this->input->post('level')));

						$cek_user = $this->db->get_where("tbl_karyawan", "username = '$username'")->num_rows();
						if ($cek_user != 0) {
								$this->session->set_flashdata('msg',
									'
									<div class="alert alert-warning alert-dismissible" role="alert">
								...
								if ($password != $password2) {
									...
									redirect('users/penggunaKR/t');
					}

					if (isset($_POST['btnupdate'])) {
						$nama_karyawan	 	= htmlentities(strip_tags($this->input->post('nama_karyawan')));
						$email	 				= htmlentities(strip_tags($this->input->post('email')));
						$alamat	 				= htmlentities(strip_tags($this->input->post('alamat')));
						$telp	 					= htmlentities(strip_tags($this->input->post('telp')));
						$pengalaman	 	  = htmlentities(strip_tags($this->input->post('pengalaman')));
						$level	 				= htmlentities(strip_tags($this->input->post('level')));
									...
									$this->Mcrud->update_karyawan(array('id_user' => $id), $data);
	...
	public function penggunaKR($aksi='', $id='')
	{
		$ceks = $this->session->userdata('surat_menyurat@Proyek-2017');
		if(!isset($ceks)) {
			redirect('web/login');
			...
			$this->db->order_by('id_userKR', 'DESC');
			$data['level_karyawan']  = $this->Mcrud->get_level_karyawan();
				...
				if ($aksi == 't') {
					...
					if (isset($_POST['btnupdate'])) {
						...
						$level	 				= htmlentities(strip_tags($this->input->post('level')));
									...
									$this->Mcrud->update_karyawan(array('id_userKR' => $id), $data);
	...
	$ceks = $this->session->userdata('surat_menyurat@Proyek-2017');
		if(!isset($ceks)) {
			...
			$data['user']  			  = $this->Mcrud->get_siswa_by_un($ceks);
			...
			$this->db->order_by('id_user', 'DESC');
				...
				if ($aksi == 't') {
					$p = "penggunaSiswa_tambah";

					$data['judul_web'] 	  = "Tambah Pengguna | WARIS";
				}elseif ($aksi == 'd') {
					$p = "penggunaSiswa_detail";

					$data['query'] = $this->db->get_where("tbl_siswa", "id_userSiswa= '$id'")->row();
					$data['judul_web'] 	  = "Detail Pengguna | WARIS";
				}elseif ($aksi == 'e') {
					$p = "penggunaSiswa_edit";
					...
					if (isset($_POST['btnsimpan'])) {
						...
						$cek_user = $this->db->get_where("tbl_siswa", "nama_lengkap = '$nama_lengkap'")->num_rows();
						if ($cek_user != 0) {
								$this->session->set_flashdata('msg',
									'
									<div class="alert alert-warning alert-dismissible" role="alert">
								...
								if ($password != $password2) {
									...
									redirect('users/penggunaSiswa/t');
					}
					...
					if (isset($_POST['btnupdate'])) {
						...
						$level	 				= htmlentities(strip_tags($this->input->post('level')));
									...
									$this->Mcrud->update_siswa(array('id_user' => $id), $data);
	...
	public function penggunaSiswa($aksi='', $id='')
	{
		$ceks = $this->session->userdata('surat_menyurat@Proyek-2017');
		if(!isset($ceks)) {
			redirect('web/login');
			...
			$this->db->order_by('id_userSiswa', 'DESC');
				...
				if ($aksi == 't') {
					...
					if (isset($_POST['btnsimpan'])) {
						...
						$cek_user = $this->db->get_where("tbl_siswa", "nama_siswa = '$nama_siswa'")->num_rows();
						if ($cek_user != 0) {
								$this->session->set_flashdata('msg',
									'
									<div class="alert alert-warning alert-dismissible" role="alert">
