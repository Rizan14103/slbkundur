...
class Mcrud extends CI_Model {
	...
	var $tbl_inventaris			= 'tbl_inventaris';
	...
	public function get_karyawan(){
		$this->db->from($this->tbl_karyawan);
		$query = $this->db->get();
	}
	...
	public function get_karyawan_daftar(){
		$this->db->from($this->tbl_karyawan);
		$this->db->where('status','terdaftar');
		$query = $this->db->get();
	}
	public function get_siswa_daftar(){
		$this->db->from($this->tbl_siswa);
		$this->db->where('status','terdaftar');
		$query =  $this->db->get();
	}
	...
	public function get_level_karyawan(){
		$this->db->from($this->tbl_karyawan);
		$query = $this->db->get();
		return $query;
	}
	...
	public function get_karyawan_by_un($id){
		$this->db->from($this->tbl_karyawan);
		$this->db->where('nama_karyawan',$id);
		$query = $this->db->get();
	}

	public function get_siswa_by_un($id){
		$this->db->from($this->tbl_siswa);
		$this->db->where('nama_siswa',$id);
		$query = $this->db->get();
	}
	...
	public function get_level_karyawan_by_id($id){
		$this->db->from($this->tbl_karyawan);
		$this->db->from('tbl_karyawan.jabatan', 'karyawan');
		$this->db->where('tbl_karyawan.id_userKR', $id);
		$query = $this->db->get();
	}
	
	public function get_level_siswa_by_id($id){
		$this->db->from($this->tbl_siswa);
		$this->db->from($this->tbl_siswa);
		$this->db->from($this->tbl_siswa);
		$query = $this->db-get();
	...
	public function save_karyawan($data){
		$this->db->insert($this->tbl_karyawan, $data);
		return $this->db->insert_id();
	}
	...
	public function update_karyawan($where, $data){
		$this->db->update($this->tbl_karyawan, $data, $where);
		return $this->db->affected_rows();
	}
	...
	public function delete_karyawan_by_id($id){
		$this->db->where('id_userKR', $id);
		$this->db->delete($this->tbl_karyawan);
	}
	public function delete_siswa_by_id($id){
		$this->db->where('id_userSiswa',$id);
		$this->db->where($this->tbl_siswa);
	}
