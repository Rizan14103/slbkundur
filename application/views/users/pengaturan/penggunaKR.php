        ...
        <div class="row">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    <br>
                    <a href="users/penggunaKR/t" class="btn btn-primary">+ <i class="icon-user"></i> Pengguna Baru</a>
                </div>
              ...
              ?>
                      ...
                      if($baris->status == "" or $baris->status == NULL){ ?>
                            ...
                            <td>
                                <a href="users/penggunaKR/d/<?php echo $baris->id_user; ?>"
                                    class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                                <a href="users/penggunaKR/e/<?php echo $baris->id_user; ?>"
                                    class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                                <a href="users/penggunaKR/h/<?php echo $baris->id_user; ?>"
