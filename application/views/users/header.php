...
<head>
    ...
    <?php
	if ($sub_menu == "pengguna" or $sub_menu == "bagian" or $sub_menu == "ns" or $sub_menu == "sm" or $sub_menu == "sk" or $sub_menu == "memo" or $sub_menu == "data_sm" or $sub_menu == "data_sk" or $sub_menu == "penggunaKR") {?>
    <!-- Theme JS files -->
                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-user">
                        <div class="category-content">
                            <div class="media">
                                <a href="users/profile" class="media-left"><img src="foto/default.png"
                    ...
                    <div class="sidebar-category sidebar-category-visible">
                        <div class="category-content no-padding">
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li class="<?php if ($sub_menu == "") { echo 'active';}?>"><a href=""><i
                                            class="icon-home4"></i> <span>BERANDA</span></a></li>
		                ...
		                if ($user->row()->level == 's_admin') { ?>
                                        <li class="<?php if ($sub_menu == "pengguna") { echo 'active';}?>"><a
                                                href="users/pengguna"><i class="icon-users"></i> USER</a></li>
                                        <?php
										}?>
                                        <li class="<?php if ($sub_menu == "bagian") { echo 'active';}?>"><a
                                                href="users/bagian"><i class="icon-puzzle3"></i> BAGIAN</a></li>
                                ...
                                <li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") { echo 'active';}?>">
                                    ...
                                    <ul>
                                        <li class="<?php if ($sub_menu == "sm") { echo 'active';}?>"><a
                                                href="users/sm"><i class="icon-folder-download2"></i> SURAT MASUK</a>
                                        </li>
                                        <li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a
                                                href="users/sk"><i class="icon-folder-upload2"></i> SURAT KELUAR</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li
                                    class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") { echo 'active';}?>">
                                    <a href="#"><i class="icon-printer4"></i> <span>PELAPORAN</span></a>
                                    <ul>
                                        <li
                                            class="<?php if ($sub_menu == "lap_sm" or $sub_menu == "data_sm") { echo 'active';}?>">
                                            <a href="users/lap_sm"><i class="icon-file-empty2"></i> SURAT MASUK</a>
                                        </li>
                                        <li
                                            class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "data_sk") { echo 'active';}?>">
                                            <a href="users/lap_sk"><i class="icon-file-empty2"></i> SURAT KELUAR</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <?php
                                if ($cek->level != "user") {?>
                                <li class="<?php if ($sub_menu == "penggunaKR") { echo 'active';}?>">
                                    <a href="#"><i class="icon-gear"></i> <span>DATA</span></a>
                                    <ul>
                                        <?php
                        if ($user->row()->level == 's_admin') { ?>
                                        <li class="<?php if ($sub_menu == "penggunaKR") { echo 'active';}?>"><a
                                                href="users/penggunaKR"><i class="icon-users"></i> DATA KARYAWAN</a>
                                        </li>
                                        <li class="<?php if ($sub_menu == "penggunaSiswa") { echo 'active';}?>">
                                            <a href="users/penggunaSiswa"><i class="icon-users"></i> DATA SISWA</a>
